                ...
                if (currentData[1] == updatedAdminName && currentData[2] == updatedEmail && currentData[3] == updatedPassword && currentData[4] == srcValue) {
                    ...
                    if (updatedEmail !== currentData[2]) {
                        ...
                        if (currentPassword === updatedPassword) {
                            ...
                            dataCollection = [currentData[0], updatedAdminName, updatedEmail, hashedUserPassword, adminProfile];
                        }

                    } else {
                        saveAdmin([currentData[0], updatedAdminName, updatedEmail, updatedPassword, srcValue]);
                    }
